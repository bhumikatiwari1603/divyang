...
import { addDisability } from "../../actions/disabilityActions";
import classnames from "classnames";

class DisabilityAdd extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
  ...
  onSubmit = e => {
    ...
    this.props.addDisability(disabilityDetails, this.props.history); 
           ...
           {/* <div className="row p-2">
              <div className ="col-md-12 bg-white">
                ...
                <div className ="col-md-5 mx-auto bg-white p-3 border">
                  ...
                  <h5 className="p-2 text-center font-weight-bold">Disability</h5>
...
DisabilityAdd.propTypes = {
  addDisability: PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{ addDisability })(withRouter(DisabilityAdd));